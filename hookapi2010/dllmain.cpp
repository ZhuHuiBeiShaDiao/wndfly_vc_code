...
INT WINAPI hook_send(SOCKET s, LPCSTR buf, INT len, INT flags);
//要Hook的进程和主线程ID号
					 ...
					 )
{
	...
	case DLL_PROCESS_ATTACH:
      ...
      //将00400000改写为我们函数的地址
      *(LPDWORD)(g_btNewBytes + 1) = (DWORD)hook_send;
...
HOOKAPI2010_API BOOL StartHook(VOID)
{
...
BOOL TestProcess(LPWSTR pszProcessName)
{
   ...
   if(::_wcsnicmp(pszFileName,pszProcessName,MAX_PATH) == 0)
   {
	   return TRUE;
   }
